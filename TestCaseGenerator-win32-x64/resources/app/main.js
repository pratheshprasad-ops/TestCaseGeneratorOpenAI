    ...
    try {
        ...
        const openAiResponse = await axios.post('https://api.openai.com/v1/chat/completions', {
            ...
            messages: [
                { 
                    role: "system",
                    content: "You are an expert QA engineer with extensive experience in creating comprehensive test cases. Your goal is to generate detailed test cases based on the provided user story and its acceptance criteria.."
                },
                { 
                    role: "user", 
                    content: `Generate detailed test cases for every aspect mentioned in the acceptance criteria for the following user story: ${description}. Focus on providing a comprehensive overview that captures the essence of the functionality being tested, ensuring that all conditions and scenarios are addressed. 
